...
$templateCache.put("/src/templates/cron.html","<cron-selection class=\"nslFormlyCron\" output=\"cronOutput\" config=\"to.cronConfig\" init=\"to.initData\" ng-disabled=\"to.readOnly || to.disabled\" ng-model=\"model[options.key]\"></cron-selection>");
...
$templateCache.put("/src/templates/textarea.html","<textarea class=\"form-control\" rows=\"{{options.templateOptions.rows? options.templateOptions.rows: \'5\'}}\" placeholder=\"{{options.templateOptions.placeholder}}\" ng-disabled=\"to.disabled\" ng-model=\"model[options.key]\"></textarea>");
