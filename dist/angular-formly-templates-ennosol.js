...
$templateCache.put("/src/templates/cron.html","<cron-selection class=\"nslFormlyCron\" output=\"cronOutput\" config=\"to.cronConfig\" init=\"to.initData\" ng-disabled=\"to.readOnly || to.disabled\" ng-hide=\"to.hide\" ng-model=\"model[options.key]\"></cron-selection>");
...
$templateCache.put("/src/templates/multiselect.html","<select ts-select2=\"to.config\" ng-model=\"model[options.key]\" multiple=\"multiple\" ng-options=\"option.value for option in to.options track by option.key\" ng-hide=\"to.hide\" nsl-select-watcher=\"\"></select>");
...
$templateCache.put("/src/templates/select.html","<select ts-select2=\"to.config\" ng-model=\"model[options.key]\" ng-hide=\"to.hide\" ng-options=\"key as value for (key, value) in to.options\" nsl-select-watcher=\"\"></select>");
...
$templateCache.put("/src/templates/tags.html","<select ts-select2=\"to.config\" ng-model=\"model[options.key]\" ng-options=\"option for option in to.options track by option\" data-tags=\"true\" ng-hide=\"to.hide\" multiple=\"multiple\"></select>");
