...
$templateCache.put("/src/templates/addoption.html","<formly-transclude></formly-transclude><button type=\"button\" title=\"{{to.title}}\" ng-class=\"to.className\" ng-disabled=\"to.disabled\" ng-click=\"to.click(id)\" ng-bind-html=\"to.text\">KUKUTYIN</button>");
