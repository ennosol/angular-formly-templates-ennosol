...
$templateCache.put("/src/templates/multiselect.html","<select ts-select2=\"to.config\" ng-model=\"model[options.key]\" multiple=\"multiple\" ng-options=\"option.value for option in to.options track by option.key\" ng-hide=\"to.hide\"></select>");
