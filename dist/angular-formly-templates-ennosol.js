...
$templateCache.put("/src/templates/label.html","<div class=\"form-group\" ng-hide=\"to.hide\"><label for=\"{{id}}\" class=\"control-label\"><span ng-bind-html=\"to.label\"></span> {{to.required ? \'*\' : \'\'}}</label><div><formly-transclude></formly-transclude></div><em id=\"{{id}}_description\" class=\"help-block\" ng-if=\"options.templateOptions.description\" style=\"opacity:0.6\">{{options.templateOptions.description}}</em></div>");
