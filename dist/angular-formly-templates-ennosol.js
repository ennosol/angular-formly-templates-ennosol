...
$templateCache.put("/src/templates/button.html","<div class=\"form-group\" ng-hide=\"to.hide\"><button type=\"button\" title=\"{{to.title}}\" ng-class=\"to.className\" ng-disabled=\"to.disabled\" ng-click=\"to.click(id)\">{{to.caption}}</button></div>");
...
$templateCache.put("/src/templates/multiselect.html","<div ng-hide=\"to.hide\"><select ts-select2=\"to.config\" ng-model=\"model[options.key]\" multiple=\"multiple\" ng-options=\"option.value for option in to.options track by option.key\"></select></div>");
...
$templateCache.put("/src/templates/select.html","<div ng-hide=\"to.hide\"><select ts-select2=\"to.config\" ng-model=\"model[options.key]\" ng-options=\"key as value for (key, value) in to.options\"></select></div>");
