...
$templateCache.put("/src/templates/select.html","<select ts-select2=\"to.config\" ng-model=\"model[options.key]\" ng-options=\"option.text for option in to.options track by option.id\"></select>");
