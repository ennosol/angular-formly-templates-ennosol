...
$templateCache.put("/src/templates/multiselect.html","<div ng-hide=\"to.hide\"><select ts-select2=\"to.config\" ng-change=\"to.change()\" ng-model=\"model[options.key]\" multiple=\"multiple\"><option value=\"{{key}}\" ng-repeat=\"(key, value) in to.options\">{{value | translate}}</option></select></div>");
...
$templateCache.put("/src/templates/select.html","<div ng-hide=\"to.hide\"><select ts-select2=\"to.config\" ng-change=\"to.change()\" ng-model=\"model[options.key]\" ng-options=\"key as value | translate for (key, value) in to.options\"></select></div>");
